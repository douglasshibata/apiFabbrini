...
export function getGlobalErrorMessage(key: string, details?: any) {
  let globalErrorMessages: Record<string, string> = {
    ...
    validUuid: $localize`:@@valid.uuid:Please provide a valid UUID, for example "e5cfaf62-c63e-30cc-9c3d-568ff3e9490e".`,
    REQUIRED_NOT_NULL: $localize`:@@required:Please provide a value.`,
    VALID_FILE_TYPE: $localize`:@@file.invalidEnding:Please provide a valid file type.`
  };
